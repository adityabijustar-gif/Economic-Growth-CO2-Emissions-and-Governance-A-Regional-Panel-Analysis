...
The final stage tests whether the principal economy-level and regional findings are sensitive to reasonable changes in sample construction and statistical inference.

The baseline economy-level specification is:
...
where \(\alpha_i\) are economy fixed effects and \(\lambda_t\) are year fixed effects. Standard errors are clustered by economy in the principal specification.

The baseline 1990–2024 estimate is:

\[
\beta = 0.653.
\]

This implies that, within economies and conditional on common year effects, a 1% increase in GDP per capita is associated with approximately a 0.65% increase in CO₂ emissions per capita. The estimate is interpreted as an association rather than a causal effect.

### Global robustness results

| Specification | GDP–CO₂ elasticity |
| --- | ---: |
| Baseline, 1990–2024 | 0.653 |
| End year 2022 | 0.666 |
| End year 2023 | 0.661 |
| Exclude 2020–2021 | 0.653 |
| Strict 1990–2024 balanced panel | 0.613 |
| Exclude Europe & North America | 0.688 |
| Exclude Developed Asia & Oceania | 0.664 |
| Exclude China | 0.656 |
| Exclude India | 0.652 |
| Exclude Global South | 0.677 |

Across the sample-based robustness checks, the estimated elasticity ranges only from approximately **0.61 to 0.69**, and every corresponding 95% confidence interval remains above zero.

The baseline coefficient is also unchanged when inference is made robust to clustering by both economy and calendar year. Two-way clustering slightly widens the confidence interval but does not alter the substantive conclusion.

The strict balanced panel contains **180 economies observed in every year from 1990 through 2024**, giving 6,300 economy-year observations. The persistence of the positive coefficient in this sample indicates that changing economy composition in the unbalanced panel is not responsible for the main result.

Leave-one-development-cluster-out tests also show that the pooled relationship is not generated by any single development group.

### Regional robustness

The regional heterogeneity established in the main fixed-effects analysis is also broadly stable across endpoint, COVID-exclusion and balanced-panel checks.

The Global South retains a particularly stable GDP–CO₂ elasticity of approximately **0.79–0.81** across the robustness specifications.

China and India also retain positive and highly stable point estimates of approximately **0.59** and **0.70**, respectively, although both are single-economy development groups and their formal clustered inference therefore requires additional caution.

Europe & North America and Developed Asia & Oceania continue to show small and statistically imprecise GDP–CO₂ slopes around zero.

These results reinforce the distinction between a positive global average relationship and substantially different development trajectories across economy groups.

## Main Findings

The analysis produces four principal findings.

1. **Economic growth remains positively associated with emissions in the pooled economy-level panel.**  
   The preferred economy and year fixed-effects model estimates a GDP-per-capita elasticity of CO₂ emissions per capita of approximately **0.65**.

2. **The global average masks substantial development heterogeneity.**  
   The Global South retains a strong positive elasticity of approximately **0.80**, while Europe & North America and Developed Asia & Oceania show small and statistically imprecise slopes around zero. China and India occupy intermediate positions with positive point estimates of approximately **0.59** and **0.70**.

3. **Observed decoupling differs sharply across development groups.**  
   Advanced-economy clusters show much greater evidence of absolute per-capita decoupling. China and India predominantly exhibit relative decoupling, while the Global South remains more strongly coupled to emissions growth.

4. **Governance is associated with these development patterns, but no stable independent governance mechanism is identified.**  
   Simple linear models suggest that higher governance scores are associated with weaker GDP–CO₂ coupling. However, the interaction becomes small after accounting for regional-development heterogeneity and changes sign when nonlinear GDP dynamics are included. The negative baseline relationship is driven primarily by persistent differences between economies rather than changes in governance within economies over time.
...
The empirical analysis is complete through the final robustness stage.

- [x] Download and clean World Bank GDP, CO₂ and population data
- [x] Construct the 1990–2024 economy-year panel
- [x] Map economies into five development clusters
- [x] Validate economy and regional data coverage
- [x] Construct population-weighted regional aggregates
- [x] Complete regional descriptive analysis
- [x] Estimate regional log-log and EKC benchmark models
- [x] Estimate economy and year fixed-effects models
- [x] Test formal regional heterogeneity
- [x] Analyse annual and long-period GDP–CO₂ decoupling
- [x] Add Government Effectiveness, Regulatory Quality and Rule of Law
- [x] Estimate governance interaction models
- [x] Test governance specification sensitivity
- [x] Decompose between- and within-economy governance variation
- [x] Complete final end-year, balanced-panel and COVID robustness checks
